...
const HE_MODELS = {
  ...
  octavia:'אוקטביה',kodiaq:'קודיאק',kamiq:'קאמיק',superb:'סופרב',karoq:'קארוק',scala:'סקאלה',enyaq:'אניאק',fabia:'פביה',rapid:'ראפיד',
...
const EN_MODELS = {
  ...
  octavia:'Octavia',kodiaq:'Kodiaq',kamiq:'Kamiq',superb:'Superb',karoq:'Karoq',scala:'Scala',enyaq:'Enyaq',fabia:'Fabia',rapid:'Rapid',
