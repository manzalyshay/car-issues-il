      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, padding: '60px 80px 60px 88px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'center' }}>
            ...
            <div style={{ color: 'white', fontSize: 80, fontWeight: 900, lineHeight: 1, marginBottom: 8 }}>
            ...
            {avgRating !== null && (
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: 13 }}>{reviews.length} ביקורות</div>
                </div>
              </div>
            )}
          </div>
