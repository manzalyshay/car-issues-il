...
export const SEED_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    body: 'טוסון 2021 עם תיבת DCT. בשנה הראשונה הרגשתי רעידות וגמגומים בנסיעה האיטית. פנייה לסוכנות — עדכנו תוכנה ועזר קצת, אבל הבעיה לא נפתרה לחלוטין. יונדאי ישראל מודעים לבעיה. זהירות.',
    category: 'mechanical',
    mileage: 32000,
